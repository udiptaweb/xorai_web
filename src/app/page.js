  ...
  return (
    <div>
      <main className="flex flex-col items-center justify-between">
        <div className="relative min-h-48 sm:min-h-96 flex place-items-center before:absolute before:h-[300px] before:w-full sm:before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full sm:after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px] z-[-1]">
          <p>
            <p className="flex items-baseline gap-x-1 ">
              <h1 className="text-5xl sm:text-9xl tracking-wide"> Xorai </h1> <span className="tracking-wider">Tech Lab</span>
            </p>
            <span className="flex items-baseline gap-x-1 ">
              Crafting Binary Brilliance
            </span>
          </p>

        </div>
        <div className="p-5 mb-32 lg:max-w-5xl lg:w-full lg:mb-0 lg:text-left">
          <p className="indent-5 mt-6 text-lg text-slate-500 dark:text-slate-300 text-justify">
            Welcome to <b className='text-white'>Xorai Tech Lab</b>, where innovation meets reliability at the crossroads of the future. Established with a vision to transform the digital landscape, we are more than just a software development company. We are pioneers, innovators, and relentless dreamers committed to pushing the boundaries of what is possible with technology. Our name, Xorai, symbolizes the harmonious blend of traditional wisdom and futuristic vision, embodying our commitment to creating solutions that are not only cutting-edge but also sustainable and forward-thinking.
          </p>
          <p className="mt-12 text-3xl sm:text-4xl text-slate-900 font-extrabold tracking-tight dark:text-slate-50">Our Mission</p>
          <p className="mt-5 text-lg text-slate-500 dark:text-slate-300 text-justify">
            At <b className='text-white'>Xorai Tech Lab</b>, our mission is simple yet ambitious: to develop innovative and reliable software solutions that solve real-world problems, drive growth, and create value for our clients and society at large. We leverage the latest in technology, coupled with rigorous research and a customer-centric approach, to deliver products and services that stand the test of time.
          </p>
          <p className="mt-12 text-3xl sm:text-4xl text-slate-900 font-extrabold tracking-tight dark:text-slate-50">Our Vision</p>
          <p className="mt-5 text-lg text-slate-500 dark:text-slate-300 text-justify">
